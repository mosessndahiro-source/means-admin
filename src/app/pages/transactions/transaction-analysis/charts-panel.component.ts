...
@Component({
  selector: 'ngx-transaction-analytics-charts',
  styleUrls: ['./charts-panel.component.scss'],
  templateUrl: './charts-panel.component.html',
})
export class TransactionAnalyticsChartsPanelComponent implements OnInit, OnDestroy {
  ...
  getChartData(period: string) {
    this.dashboardClient.transactionAnalytics(period)
      .subscribe((response) => {
